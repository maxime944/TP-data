...
df1 = pd.read_csv('trafic-annuel-entrant-par-station-du-reseau-ferre-2021.csv')
...
fig5 = px.scatter_mapbox(df2, lat="lat", lon="lng", hover_name="nom_long", hover_data=["Geo Point", "exploitant"],
